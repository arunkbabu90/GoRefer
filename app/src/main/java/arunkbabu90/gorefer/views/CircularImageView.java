package arunkbabu90.gorefer.views;
...
public class CircularImageView extends MaterialCardView {
    ...
    public CircularImageView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBackgroundColor = a.getColor(R.styleable.CircularImageView_android_background, ContextCompat.getColor(context, android.R.color.white));
        } finally {
            a.recycle();
        }
        initializeViews(context);
